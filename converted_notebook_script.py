...
# token = UserSecretsClient().get_secret("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") 
...
# Clone the repository and install the packages of vistral-V
subprocess.run(["git", "clone", "https://github.com/hllj/Vistral-V.git"])
subprocess.run(["pip", "install", "-e", "./Vistral-V"])
subprocess.run(["pip", "install", "llava"])
subprocess.run(["pip", "install", "transformers==4.41.2", "-q"])

# Install additional packages
subprocess.run(["pip", "install", "ipykernel", "-q"])
...
# image_file = "C:/Users/Hoang Long/Desktop/Vistral/chamber.jpg"
...
debug = False
device = "cuda" # device = "cuda" if you want to inference with multiple GPU devices
